        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-t border-line-trace px-6 py-4 bg-canvas-warm/10">
          ...
          <div className="flex items-center justify-between sm:justify-end gap-2 w-full sm:w-auto">
            <button
              ...
              className="inline-flex h-8 items-center justify-center rounded border border-brand-black/15 bg-canvas-pure px-3 text-xs font-semibold text-brand-black hover:bg-canvas-warm disabled:opacity-50 disabled:hover:bg-canvas-pure transition-colors cursor-pointer"
            >
              Sebelumnya
            </button>
            <button
