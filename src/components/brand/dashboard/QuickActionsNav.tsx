...
export function QuickActionsNav(): ReactElement {
  return (
    <section className="rounded-2xl border border-line-trace bg-canvas-pure p-6 space-y-4">
      ...
      <nav aria-label="Menu Aksi Cepat" className="flex flex-col gap-2.5">
        <Link
          href="/material"
          className="flex items-center justify-between rounded-xl border border-line-trace bg-canvas-pure p-3.5 text-xs font-semibold text-brand-black transition hover:border-brand-emerald hover:bg-canvas-warm/30 group"
        >
