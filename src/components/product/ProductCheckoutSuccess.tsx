  ...
  return (
    <section className="mx-auto max-w-2xl rounded-3xl border border-brand-black/15 bg-canvas-pure px-6 py-14 text-center sm:px-10">
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2">
        <Link
          href="/produk"
          className="flex items-center justify-center gap-2 rounded-md border border-brand-black/15 px-6 py-4 text-xs font-bold text-brand-black transition hover:border-brand-forest"
        >
          Belanja Lagi
        </Link>
