...
Kode halaman yang dibuat harus bersifat modular dan reusable. Oleh sebab itu, selalu letakkan komponen-komponen yang bersifat reusable pada folder yang terpisah. Selain itu, kode untuk halaman tidak boleh lebih dari 250 baris agar mudah dibaca.

Untuk mengubah style UI dari MURI, selalu ikuti style guide yang ada pada file `.agents/skills/muri-guide/references/STYLEGUIDE.md`. Ubahlah jika memang ada instruksi eksplisit untuk melakukannya, namun jangan mengubah style UI dari MURI tanpa ada instruksi eksplisit.
